      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-8">Poems</h1>
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-12 shadow-lg">
              <p className="text-lg text-gray-600 mb-6">
                This is a placeholder for the Poems page. The content for this section is ready to be filled in.
              </p>
